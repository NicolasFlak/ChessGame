...
public class Game { //NE PAS TOUCHER LA LOGIQUE
    ...
    private void initialisation() {
        ...
        String w;
        do {
            System.out.println("Pour lancer le jeu en mode normal : taper 'normal'");
            w = entree.nextLine();
        }
    ...
    private void jouer(Joueur j) {
        ...
        while (!temp2) {
            ...
            temp = false;
            arrivee = getEntree(2);
            temp2 = joueurActuel.bougerT2(selectionnee, echiquier, arrivee);
